...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⪦ 𝕄𝕆𝕍𝕀𝔼 ℂℍ𝔸ℕℕ𝔼𝕃 ⪧', url='https://t.me/+6hvCoblt6CxhZjhl')
        ],[
        ...
        try:
            ...
            reply_markup = InlineKeyboardMarkup(btn)
            await client.send_message(int(user_id), f"😒 ওহো বন্ধু , তোমার অনুরোধ করা কন্টেন্টের নাম `{movie}` এই মুহূর্তে এটা নেই, আমরা আপনাকে এই কন্টেন্টটি পরিবেশন করার জন্য যথাসাধ্য চেষ্টা করছি, আপনি কি দয়া করে আপনার প্রশ্নের সাথে সম্পর্কিত আরও কিছু তথ্য আমাদের জানান? `{movie}`, \nSend details to Admin : <a href='https://telegram.me/{ADMIN_USRNM}'>**Send here...**</a>\n\n❤ Thank You for the contribution", reply_markup=reply_markup)
        ...
        try:
            ...
            reply_markup_lzdv = InlineKeyboardMarkup(btn_lzdv)            
            reply_markup = InlineKeyboardMarkup(btn)
            await client.send_message(int(user_id), f"🛋 হ্যালো বন্ধু , তোমার অনুরোধ করা কন্টেন্টের নাম `{movie}` আমাদের ডাটাবেসে ইতিমধ্যেই পাওয়া যাচ্ছে! আমাদের অফিসিয়াল গ্রুপে এর সঠিক নাম অনুসন্ধান করে আপনি সহজেই এই সিনেমাটি পেতে পারেন।...\nSend details to Admin : \n\n❤ Thank You for the contribution", reply_markup=reply_markup)
    ...
    if imdb and imdb.get('poster'):
        try:
            z = await message.reply_photo(photo=imdb.get('poster'), caption=cap[:1024],
                                        reply_markup=InlineKeyboardMarkup(btn))
            thanksaa = await message.reply_text(f"♥ Heads up for **<a href='https://t.me/ctgmovies23'>𓆩• CTGMovieOfficial •𓆪</a>**...\n<code>🎉 we love you 🎊</code>")
            ...
            thanks = await message.reply_text(f"♥ Heads up for **<a href='https://t.me/ctgmovies23'>𓆩• CTGMovieOfficial •𓆪</a>**...\n<code>🎉 we love you 🎊</code>")
            await asyncio.sleep(5)
            await thanks.delete()
            if SELF_DELETE:
                await asyncio.sleep(SELF_DELETE_SECONDS)
            ...
            thanksz = await message.reply_text(f"♥ Heads up for **<a href='https://t.me/ctgmovies23'>𓆩• CTGMovieOfficial •𓆪</a>**...\n<code>🎉 we love you 🎊</code>")
            await asyncio.sleep(5)
        ...
        thanksx = await message.reply_text(f"♥ Heads up for **<a href='https://t.me/ctgmovies23'>𓆩• CTGMovieOfficial •𓆪</a>**...\n<code>🎉 we love you 🎊</code>")
        await asyncio.sleep(5)
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        k = await msg.reply(f"হ্যালো বন্ধু! অনুরোধ করা কন্টেন্টটি বর্তমানে আমাদের ডাটাবেসে নেই , একটু ধৈর্য ধরুন 🙂 - আমাদের দুর্দান্ত অ্যাডমিন যত তাড়াতাড়ি সম্ভব এটি আপলোড করবেন। \n\n               **or**\n\nDiscuss issue with admin here 👉  <a href='https://t.me/{DISCUSSION_CHAT_USRNM}'>{DISCUSSION_TITLE}</a> ♥️ ")
        await asyncio.sleep(10)
        await k.delete()
        return
