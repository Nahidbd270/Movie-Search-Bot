...
PICS = (environ.get('PICS', 'https://i.ibb.co/C549bzJ3/photo-2025-03-07-15-31-53-7479090753143046156.jpg')).split()
...
# MongoDB information *
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rimeni8975:rimeni8975@cluster0.dy7w3.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
QR_CODE_IMG = environ.get('QR_CODE_IMG','https://envs.sh/ykc.jpg') #add url link of your qr code to recieve money - use telegraph bot or other source to get image
UPI_ID = environ.get('Admin_id', 'Ctgmocies23') #enter your Admin id here - grab it from your online payment methods.

# Others
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/HowtoDowlnoad/2') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'freehub4u93')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "False")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), False)
CUSTOM_FILE_CAPTION ="""<b>[{file_name}](https://t.me/+V_VTlzmuPqY3MTc9)\n\n<b>•────•────────•────•\n📌 ʀᴇǫᴜᴇsᴛ ɢʀᴏᴜᴘ : [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://t.me/+YLEjnZL6CSZlNDk1)\n🎬 ᴍᴏᴠɪᴇs ᴄʜᴀɴɴᴇʟ : [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://t.me/freemoviesLink02)\n•────•────────•────•\n\n©️ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : [CTG MOVIES](https://t.me/Movie_Request_Group_23)</b>"</b>
...
DOWNLOAD_TEXT_URL = "https://t.me/HowtoDowlnoad/2"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/AllBotUpdatemy"
